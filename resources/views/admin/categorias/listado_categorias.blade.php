@extends('admin.dashboard')
    ...
    @section('breadcrumb')
        <h4 class="page-title-main">Categorias</h4>
        <ol class="breadcrumb">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="header-title">Listado categorías</h4>
                            
                            <div class="row mt-3">
                                <a href="{{asset('/admin/categorias/nueva')}}" class="btn btn-primary waves-effect waves-light ml-2">Nueva Categoría</a>
