        ...
        <div class="row">
            <div class="col">
                ...
                <div class="text-center">
                    {{-- <p><a href="#">New Arrivals</a> <a href="#">Best Sellers</a> <a href="#">Extended Widths</a> <a href="#">Sale</a></p> --}}
                    <p style="font-size: 1.5em"> <strong> Contamos con una amplia gama de productos de aseo de excelente calidad, supliendo las necesidades de hogares, negocios y oﬁcinas, ajustándonos a las diferentes necesidades de cada uno de nuestros clientes.</strong></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="colorlib-partner">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col partner-col text-center">
                    <img src="{{asset('img/marcas/aseo/pinolina.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
                </div>
                <div class="col partner-col text-center">
                    <img src="{{asset('img/marcas/aseo/protex.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
                </div>
                <div class="col partner-col text-center">
                    <img src="{{asset('img/marcas/aseo/blancox.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
                </div>
                <div class="col partner-col text-center">
                    <img src="{{asset('img/marcas/aseo/ultrex.png')}}" class="img-fluid" alt="Free html4 bootstrap 4 template">
                </div>
            </div>
        </div>
    </div>
